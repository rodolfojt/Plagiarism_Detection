...
if __name__ == '__main__':
	...
	# Model Parameters
	parser.add_argument('--input-features', type=int, default=2, metavar='N',
						help='input features dim (default: 2)')
	parser.add_argument('--hidden-dim', type=int, default=4, metavar='N',
						help='hidden dim (default: 10)')
	parser.add_argument('--output-dim', type=int, default=2, metavar='N',
						help='output dim (default: 2)')
